<template>
    <v-form ref="form" class="text-left">
        <TheSearchForFreelancerSearchPanel
            :countries="countries"
            :cities="cities"
        ...
        <TheSearchForFreelancerSearchSelector @change="updateSearchValues"></TheSearchForFreelancerSearchSelector>
...
import TheSearchForFreelancerSearchPanel from "@/components/TheSearchForFreelancerSearchPanel";
import TheSearchForFreelancerSearchSelector from "@/components/TheSearchForFreelancerSearchSelector";
...
export default {
    ...
    components: {
        TheSearchForFreelancerSearchPanel,
        TheSearchForFreelancerSearchSelector
    },
